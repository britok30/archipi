...
export default {
  ...
  info: {
    title: "Upper Kitchen Cabinet",
    tag: ["furnishings","kitchen"],
    description: "Wall-mounted upper kitchen cabinet",
    image: "/images/kitchen-cabinet-upper.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/kitchen-cabinet-upper.glb");
