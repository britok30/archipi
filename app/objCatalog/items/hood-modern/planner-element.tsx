...
export default {
  ...
  info: {
    title: "Modern Range Hood",
    tag: ["furnishings","kitchen"],
    description: "Modern range hood",
    image: "/images/hood-modern.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newAltitude = readItemLength(element.properties?.altitude, scene, 150);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/hood-modern.glb");
