...
export default {
  ...
  info: {
    title: "Cross-Leg Table with Cloth",
    tag: ["furnishings","kitchen","living"],
    description: "Cross-leg table with tablecloth",
    image: "/images/table-cross-cloth.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/table-cross-cloth.glb");
