...
export default {
  ...
  info: {
    ...
    description: "Square rug",
    image: "/images/rug-square.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    ...
    let newDepth = readItemLength(element.properties?.depth, scene, 160);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newDepth = readItemLength(element.properties?.depth, scene, 160);
    ...
    const model = await loadGlb("/models/rug-square.glb");
