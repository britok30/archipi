...
export default {
  ...
  info: {
    title: "Square Table Lamp",
    tag: ["furnishings","decor"],
    description: "Square table lamp",
    image: "/images/lamp-square-table.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidth = readItemLength(element.properties?.width, scene, 30);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    const newWidth = readItemLength(element.properties?.width, scene, 30);
    ...
    const model = await loadGlb("/models/lamp-square-table.glb");
