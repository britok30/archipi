...
function makeObjectMaxLOD(newWidthA: any, newWidthB: any, newHeight: any, newDepth: any) {
  ...
  let index: any;
  let indexMonitor: any;
  let lastPosition: any;
  let lastPositionMonitor: any;
  let incrPosition: any;
...
function makeObjectMinLOD(newWidthA: any, newWidthB: any, newHeight: any, newDepth: any) {
  let desk = new Three.Mesh();
...
export default {
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidthA = element.properties?.widthA?.length;
    let newWidthB = element.properties?.widthB?.length;
    let newDepth = element.properties?.depth?.length;
  ...
  render3D: function (element: any, layer: any, scene: any) {
    ...
    let newWidthB = element.properties?.widthB?.length;
    let newDepth = element.properties?.depth?.length;
    let newHeight = element.properties?.height?.length;
