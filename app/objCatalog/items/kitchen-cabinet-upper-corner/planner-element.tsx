...
export default {
  ...
  info: {
    ...
    description: "Wall-mounted upper corner cabinet",
    image: "/images/kitchen-cabinet-upper-corner.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/kitchen-cabinet-upper-corner.glb");
