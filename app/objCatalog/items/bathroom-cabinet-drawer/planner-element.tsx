...
export default {
  ...
  info: {
    title: "Bathroom Drawer Cabinet",
    tag: ["furnishings","bathroom"],
    description: "Bathroom cabinet with drawers",
    image: "/images/bathroom-cabinet-drawer.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/bathroom-cabinet-drawer.glb");
