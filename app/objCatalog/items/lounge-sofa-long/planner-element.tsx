...
export default {
  ...
  info: {
    ...
    description: "Long three-seat sofa",
    image: "/images/lounge-sofa-long.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    ...
    let newDepth = readItemLength(element.properties?.depth, scene, 150);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newDepth = readItemLength(element.properties?.depth, scene, 150);
    ...
    const model = await loadGlb("/models/lounge-sofa-long.glb");
