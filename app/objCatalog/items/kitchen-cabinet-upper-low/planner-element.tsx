...
export default {
  ...
  info: {
    title: "Upper Low Cabinet",
    tag: ["furnishings","kitchen"],
    description: "Wall-mounted low upper cabinet",
    image: "/images/kitchen-cabinet-upper-low.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newAltitude = readItemLength(element.properties?.altitude, scene, 170);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/kitchen-cabinet-upper-low.glb");
