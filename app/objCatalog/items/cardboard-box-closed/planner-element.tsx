...
export default {
  ...
  info: {
    title: "Closed Cardboard Box",
    tag: ["furnishings","decor"],
    description: "Closed cardboard box",
    image: "/images/cardboard-box-closed.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/cardboard-box-closed.glb");
