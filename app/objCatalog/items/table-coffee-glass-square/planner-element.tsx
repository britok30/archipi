...
export default {
  ...
  info: {
    title: "Square Glass Coffee Table",
    tag: ["furnishings","living"],
    description: "Square glass coffee table",
    image: "/images/table-coffee-glass-square.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    ...
    let newDepth = readItemLength(element.properties?.depth, scene, 80);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newDepth = readItemLength(element.properties?.depth, scene, 80);
    ...
    const model = await loadGlb("/models/table-coffee-glass-square.glb");
