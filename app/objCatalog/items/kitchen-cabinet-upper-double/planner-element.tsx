...
export default {
  ...
  info: {
    title: "Upper Double Cabinet",
    tag: ["furnishings","kitchen"],
    description: "Wall-mounted upper cabinet with double doors",
    image: "/images/kitchen-cabinet-upper-double.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newAltitude = readItemLength(element.properties?.altitude, scene, 140);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/kitchen-cabinet-upper-double.glb");
