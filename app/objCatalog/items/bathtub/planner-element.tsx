...
export default {
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidth = readItemLength(element.properties?.width, scene, 170);

    let newDepth = readItemLength(element.properties?.depth, scene, 75);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    const newWidth = readItemLength(element.properties?.width, scene, 170);

    const newDepth = readItemLength(element.properties?.depth, scene, 75);
    ...
    const model = await loadGlb("/models/bathtub.glb");
