...
export default {
  ...
  info: {
    ...
    description: "Long pillow",
    image: "/images/pillow-long.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    ...
    let newDepth = readItemLength(element.properties?.depth, scene, 18);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newDepth = readItemLength(element.properties?.depth, scene, 18);
    ...
    const model = await loadGlb("/models/pillow-long.glb");
