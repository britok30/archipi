...
export default {
  ...
  info: {
    title: "Corner Kitchen Cabinet",
    tag: ["furnishings","kitchen"],
    description: "Inner corner kitchen cabinet",
    image: "/images/kitchen-cabinet-corner-inner.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/kitchen-cabinet-corner-inner.glb");
