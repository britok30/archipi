...
export default {
  ...
  info: {
    title: "Bathroom Wall Cabinet",
    tag: ["furnishings","bathroom"],
    description: "Wall-mounted bathroom cabinet",
    image: "/images/bathroom-cabinet.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newAltitude = readItemLength(element.properties?.altitude, scene, 120);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/bathroom-cabinet.glb");
