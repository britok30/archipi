...
export default {
  ...
  info: {
    ...
    description: "Corner shower with rounded front",
    image: "/images/shower-round.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newHeight = readItemLength(element.properties?.height, scene, 200);

    const newAltitude = readItemLength(element.properties?.altitude, scene, 0);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/shower-round.glb");
