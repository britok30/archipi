...
export default {
  ...
  info: {
    ...
    description: "Square ceiling lamp",
    image: "/images/lamp-square-ceiling.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newAltitude = readItemLength(element.properties?.altitude, scene, 240);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/lamp-square-ceiling.glb");
