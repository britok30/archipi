...
export default {
  ...
  info: {
    title: "Kitchen Bar End",
    tag: ["furnishings","kitchen"],
    description: "Kitchen bar counter end piece",
    image: "/images/kitchen-bar-end.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidth = readItemLength(element.properties?.width, scene, 15);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    const newWidth = readItemLength(element.properties?.width, scene, 15);
    ...
    const model = await loadGlb("/models/kitchen-bar-end.glb");
