...
export default {
  ...
  info: {
    title: "Designer Corner Sofa",
    tag: ["furnishings","living"],
    description: "Designer corner sofa",
    image: "/images/lounge-design-sofa-corner.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidth = readItemLength(element.properties?.width, scene, 220);

    let newDepth = readItemLength(element.properties?.depth, scene, 220);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    const newWidth = readItemLength(element.properties?.width, scene, 220);

    const newDepth = readItemLength(element.properties?.depth, scene, 220);
    ...
    const model = await loadGlb("/models/lounge-design-sofa-corner.glb");
