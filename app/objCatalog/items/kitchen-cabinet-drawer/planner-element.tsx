...
export default {
  ...
  info: {
    title: "Kitchen Drawer Cabinet",
    tag: ["furnishings","kitchen"],
    description: "Kitchen cabinet with drawers",
    image: "/images/kitchen-cabinet-drawer.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/kitchen-cabinet-drawer.glb");
