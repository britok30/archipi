...
export default {
  ...
  info: {
    title: "Open Stairs (Single Rail)",
    tag: ["building","stair"],
    description: "Open staircase with a single rail",
    image: "/images/stairs-open-single.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/stairs-open-single.glb");
