...
export default {
  ...
  info: {
    ...
    description: "Standing coat rack",
    image: "/images/hanger.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidth = readItemLength(element.properties?.width, scene, 50);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    const newWidth = readItemLength(element.properties?.width, scene, 50);
    ...
    const model = await loadGlb("/models/coat-rack-standing.glb");
