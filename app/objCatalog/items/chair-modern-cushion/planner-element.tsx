...
export default {
  ...
  info: {
    title: "Modern Cushioned Chair",
    tag: ["furnishings","living","kitchen"],
    description: "Modern chair with cushion",
    image: "/images/chair-modern-cushion.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const model = await loadGlb("/models/chair-modern-cushion.glb");
