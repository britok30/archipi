...
export default {
  ...
  info: {
    title: "Stacked Washer & Dryer",
    tag: ["furnishings","bathroom","kitchen"],
    description: "Stacked washer and dryer",
    image: "/images/washer-dryer-stacked.png",
  },
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newHeight = readItemLength(element.properties?.height, scene, 170);

    const newAltitude = readItemLength(element.properties?.altitude, scene, 0);

    const item = new Three.Object3D();
    const model = await loadGlb("/models/washer-dryer-stacked.glb");
