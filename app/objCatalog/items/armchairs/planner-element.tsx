...
export default {
  ...
  render2D: function (element: any, layer: any, scene: any) {
    ...
    let newDepth = readItemLength(element.properties?.depth, scene, 85);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    ...
    const newDepth = readItemLength(element.properties?.depth, scene, 85);
    ...
    const model = await loadGlb("/models/lounge-chair.glb");
