...
export default {
  ...
  render2D: function (element: any, layer: any, scene: any) {
    ...
    let text_style ={textAnchor: 'middle' as const, fontSize: '11px', fill: '#FF0000'};
    ...
    let seats = element.properties?.seat;
    let flip = element.properties?.flip;
  ...
  render3D: function (element: any, layer: any, scene: any) {
    ...
    let seatArray = new Array(seats);
      ...
      function setArmchairsPos(listObject: any,seats: any) {
    ...
    function makeSeriesArmchair2(seats: any) {
    ...
    function makeSeriesArmchair1(seats: any) {
