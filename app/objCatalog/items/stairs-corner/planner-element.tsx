...
export default {
  ...
  info: {
    title: "Corner Stairs",
    tag: ["building","stair"],
    description: "L-shaped corner staircase",
    image: "/images/stairs-corner.png",
  },
  ...
  render2D: function (element: any, layer: any, scene: any) {
    let newWidth = readItemLength(element.properties?.width, scene, 280);

    let newDepth = readItemLength(element.properties?.depth, scene, 230);
  ...
  render3D: async function (element: any, layer: any, scene: any) {
    const newWidth = readItemLength(element.properties?.width, scene, 280);

    const newDepth = readItemLength(element.properties?.depth, scene, 230);
    ...
    const model = await loadGlb("/models/stairs-corner.glb");
