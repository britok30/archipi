...
//colors
const grey = new Three.MeshBasicMaterial({ color: 0xeae6ca });

function makeObjectMaxLOD(WIDTH: any, HEIGHT: any) {
...
function makeObjectMinLOD(WIDTH: any, HEIGHT: any) {
  let OldStyleRadiator = new Three.Mesh();
  let roundedRectShape = new Three.Shape();
...
export default {
  ...
  info: {
    ...
    image: "/images/OldStyleRadiator.png",
  },
