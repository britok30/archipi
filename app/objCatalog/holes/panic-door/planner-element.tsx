...
function makePanicDoor(handleSide: any) {
...
function makeHandle(handleSide_value: any) {
  let handle = new Three.Object3D();
...
function makeHandleBase(handleSide_value: any) {
...
export default {
  ...
  info: {
    tag: ["door"],
    title: "panic door",
    description: "Panic Door",
    image: "/images/panicDoor.png",
  },
  ...
  render3D: function (element: any, layer: any, scene: any) {
    ...
    let handleSide = element.properties?.flip_vertical;
